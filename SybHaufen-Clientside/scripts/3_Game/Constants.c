...
const int NTFKEY_DISINFECTED = 1120;
const int NTFKEY_ANTIDEPRESANT = 1121;
...
const int LEVELED_NTFKEY_BADGES[LEVELED_NTFKEY_BADGES_COUNT] = { 
	...
	NTFKEY_ANTIBIOTIC, NTFKEY_STOMATCHPOISONING, NTFKEY_STOMATCHHEAL, NTFKEY_ANTIDEPRESANT 
};
...
modded class PlayerConstants
{
	...
	static const float HEALTH_REGEN_MAX	= 0.007;	//health regen rate at MAXIMUM blood level
